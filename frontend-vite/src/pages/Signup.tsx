        ...
        <Card>
          <form onSubmit={onSubmit}>
            <CardHeader>
              ...
              <CardDescription>Sign up to get started with LearnLab</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  minLength={6}
                />
                <p className="text-xs text-dim">Must be at least 6 characters</p>
              </div>
              {err && (
